...
\def\papertitle{A New Paradigm for Sound Design}
\def\paperauthorA{Ananya Misra, Perry R. Cook, Ge Wang}
...
\affiliation{Ananya Misra, Perry R. Cook$^{\dag}$, Ge Wang}	% This command replaces \name{The DAFx Crew} 
...
%  \subfigure[]{\includegraphics[width=.155\textwidth]{fireworktracks2.eps}} 
%.7159*.22=.1575
...
%time domain \cite{paper:85:Verma98}. However, they are generally brief and continuous enough to be 
...
%either explicitly or using a probability distribution for repeating events.  
...
\bibliography{85} % requires file 85.bib
