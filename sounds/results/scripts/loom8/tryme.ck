...
fun void section_three()
{
    ...
    // freq up/down
    spork ~ Loom.freqTo( birdloop, .5, 3::second ); 3::second => now;
    spork ~ Loom.freqTo( birdloop, .25, 3::second ); 3::second => now;
    // density down/up
    spork ~ Loom.densityTo( birdloop, 8, 3::second ); 3::second => now;
    spork ~ Loom.densityTo( birdloop, 30, 3::second ); 3::second => now;

    // freq up/down
    spork ~ Loom.freqTo( birdloop, .75, 4::second ); 4::second => now;
    spork ~ Loom.freqTo( birdloop, .25, 2::second ); 4::second => now;
    // density down/up
    spork ~ Loom.densityTo( birdloop, 6, 5::second ); 5::second => now;
    spork ~ Loom.densityTo( birdloop, 30, 3::second ); 3::second => now;

    // time down
    spork ~ Loom.stretchTo( birdloop, .025, 5::second ); 5::second => now;
    ...
    spork ~ Loom.gainTo( birdloop, .001, 8::second );
